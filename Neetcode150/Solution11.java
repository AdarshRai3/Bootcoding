public class Solution11 {
    ...
    public int maxArea(int[] height) {
        ...
        // then we low and high pointer where low starts from 0 and high = height.length
        // -1
        int low = 0;
        ...
        while (low < high) {
            ...
            // to get greater area we need height if height[low]>height[high] we do high--
            // to find greater height by moving left and otherwise we will move right by
            // moving low++ to find greater height
